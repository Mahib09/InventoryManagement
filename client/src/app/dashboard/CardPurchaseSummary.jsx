...
const CardPurchaseSummary = () => {
  ...
  const totalPurchased = lastDataPoint.totalPurchased
    ? numeral(lastDataPoint.totalPurchased).format("$0.00a")
    : "0";

  const changePercentage = lastDataPoint.changePercentage || 0;

  return (
    <div className="row-span-2 justify-between xl:row-span-3 col-span-1 md:col-span-2 xl:col-span-1 bg-white shadow-md rounded-2xl">
      {isLoading ? (
